...
par(mfrow=c(2,2))
with(EDA_power_Feb_transform, plot(date_time, Global_active_power, type='l', xlab=' ',ylab='Global Active Power'))
with(EDA_power_Feb_transform,plot(date_time, Voltage, type = 'l',xlab = 'datetime',ylab = 'Voltage'))
with(EDA_power_Feb_transform,plot(date_time,Sub_metering_1, col='black',type = 'l',ylab='Energy sub metering',xlab = " "))
lines(EDA_power_Feb_transform$date_time,EDA_power_Feb_transform$Sub_metering_2,col='red', type = 'l')
lines(EDA_power_Feb_transform$date_time,EDA_power_Feb_transform$Sub_metering_3,col='blue', type = 'l')
legend("topright", lwd  = 1, col = c("black", "red","blue"), legend = c("Sub_metering_1", "Sub_metering_2","Sub_metering_3"),bty = 'n')
with(EDA_power_Feb_transform, plot(date_time, Global_reactive_power, type='l', xlab='datetime'))
